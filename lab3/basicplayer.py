...
def basic_evaluate(board):
    ...
    #print 'eval score: ', score, 'player id: ', board.get_current_player_id()
    return score
...
def minimax_find_board_value(board, depth, eval_fn,
    ...
    for move, new_board in get_next_moves_fn(board):
        ...
        # print 'got board value: ', val , 'current player: ', new_board.get_current_player_id(), 'depth: ', 3 - depth
